...
R={1:["priority","rationale","source type","work iq attempted"],2:["schedule","scope","outputs","approval"],3:["p1","p2","p3","allowed labels","human check"],4:["schedule","scope","outputs","review surface","guardrail"],5:["decision","evidence","rubric rule","human reviewer"],6:["automation","context","human review","future automation"]}
