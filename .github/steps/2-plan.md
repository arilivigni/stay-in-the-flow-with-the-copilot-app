## Step 2: Plan a supervised workflow
...
<!-- step-2-plan:start -->
Schedule: daily
Scope: newly opened issues in this exercise repository
Outputs: summary, priority recommendation, topic label recommendation, rationale
Approval: a human approves every repository mutation
<!-- step-2-plan:end -->
```
